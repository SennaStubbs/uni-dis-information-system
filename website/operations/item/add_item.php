<?php
    ...
    if (isset($_POST['item_name']) && isset($_POST['item_rarity']) && isset($_POST['item_sell_value']) && isset($_POST['item_total_times_collected']) && isset($_POST['item_total_times_sold'])) {
        ...
        $item_sell_value = filter_var((int)$_POST['item_sell_value'], FILTER_SANITIZE_NUMBER_INT);
        $item_total_times_collected = filter_var((int)$_POST['item_total_times_collected'], FILTER_SANITIZE_NUMBER_INT);
        $item_total_times_sold = filter_var((int)$_POST['item_total_times_sold'], FILTER_SANITIZE_NUMBER_INT);
    }
    else {
        echo 'error';
        exit();
